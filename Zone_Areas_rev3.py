...
for index,element in enumerate(value):
    ...
    if check == '':
        continue
    if element.propertyValues[3].propertyValue.value == 'a 063   Einheitenfläche': # 'A - Zones - Floor Areas.3D'
    ...
    elif element.propertyValues[3].propertyValue.value == 'a 063   Raumstempel': # 'A - Zones - Room.3D'
